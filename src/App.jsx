    ...
    >
      תהליך ייעוץ וליווי מלא להורים ולזוגות
        ...
        >
          ...
          .עבדתי עם אלפי הורים וילדים במגוון מסגרות חינוכיות – בתי ספר תיכוניים, חטיבות ביניים ובתי ספר יסודיים<br/><br/>
          אני מכירה את הקשיים שמלווים כל גיל ושלב בהתפתחות הילד, ומביאה עימי כלים וגישות טיפוליות מותאמות<br/>
           לכל משפחה.

          המטרה שלי היא להעניק להורים את המשאבים, הידע והעקרונות שיסייעו להם לבנות קשר חזק ובריא עם <br/>
          .הילדים, להתמודד עם אתגרי היום-יום וליצור בבית אווירה של תמיכה, הבנה ושיתוף פעולה
          </Typography>
        </Box>
...
>
  ...
  >
    ...
    <Typography variant="body1" paragraph>
      ...
      התהליך משתנה בהתאם לצרכים האישיים של כל משפחה. יש משפחות שיכולות לראות <br />
      .התקדמות משמעותית בשתיים-שלוש פגישות, ויש כאלו שזקוקות ליותר זמן ותמיכה
    ...
    <Typography variant="body1" paragraph>
      ...
      .המפגשים מתקיימים באורנית/הוד השרון. יש אםשרות גם לפגישות מקוונות
          </Typography>
  </Box>
</Box>
            ...
            >
              ...
              >
                ...
                <Stack spacing={2} sx={{width: "130%", height: "auto",}}>
                  ...
                  >
                    הדרכת הורים - כלים להתמודדות עם אתגרים משפחתיים
                  </Button>
                  <Button
                    variant="contained"
                    disabled
                  ...
                  >
                    הרצאות וסדנאות בחברות וארגונים המציעות כלים ותמיכה בהורים
                  </Button>
                  <Button
                    variant="contained"
                    disabled
                  ...
                  >
                    הדרכות לצוותי חינוך להעמקת הכלים החינוכיים והתמודדות עם אתגרים מקצועיים
                  </Button>
                </Stack>
